...
--
-- Host: localhost:3306
-- Generation Time: Nov 19, 2024 at 07:19 AM
...
CREATE TABLE `channel_conversations` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `convable_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `convable_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '(DC2Type:guid)',
...
CREATE TABLE `channel_lists` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `channelable_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `channelable_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '(DC2Type:guid)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(11, 'new_message', 'You got a new message from {userName}', 1, NULL, '2024-11-04 07:12:48'),
(12, 'payment_successful', '{paidAmount} payment successful on this trip by {methodName}.', 1, NULL, '2024-11-04 07:12:48'),
...
(31, 'ride_is_started', 'Another driver already accept the trip request.', 1, NULL, '2023-11-20 11:27:20'),
...
(52, 'someone_used_your_code', 'Your code was successfully used by a friend. You\'ll receive your reward after their first ride is completed.', 1, '2024-09-21 21:56:14', '2024-09-21 21:56:14'),
(53, 'referral_reward_received', 'You\'ve successfully received {referralRewardAmount} reward. You can use this amount on your next ride.', 1, '2024-09-21 21:56:14', '2024-09-21 21:56:14'),
(54, 'parcel_returned', 'Parcel returned successfully', 1, '2024-09-21 21:56:14', '2024-09-21 21:56:14'),
(55, 'parcel_returning_otp', 'Your parcel returning OTP is {otp}', 1, '2024-09-21 21:56:14', '2024-09-21 21:56:14');
...
CREATE TABLE `question_answers` (
  ...
  `question_answer_for` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'driver',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
