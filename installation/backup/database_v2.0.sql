...
--
-- Host: localhost:3306
-- Generation Time: Nov 04, 2024 at 01:14 PM
...
CREATE TABLE `parcel_refunds` (
  ...
  `coupon_setup_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `deny_note` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `parcel_refund_proofs` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `parcel_refund_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `zones` (
  ...
  `extra_fare_reason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
