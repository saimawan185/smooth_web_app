        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.business.pages-media.landing-page.earn-money.update') }}"
                            ...
                            <div class="col-md-6">
                                <div class="d-flex flex-column gap-3 mb-4">
                                    ...
                                    <div class="d-flex">
                                        <div class="upload-file">
                                            <input type="file" class="upload-file__input" name="image"
                                                   accept="image/png, image/jpeg, image/jpg, image/webp" {{ $data1?->value['image'] ? '' : 'required'}}>
                                            <span class="edit-btn">
                                    ...
                                    <div class="d-flex flex-column gap-1">
                                        ...
                                        <p class="fs-12">{{ translate('Image format : jpg, png, jpeg, webp | Maximum size : 5MB') }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
