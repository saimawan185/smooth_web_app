                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-4">
                                            ...
                                            <textarea name="reference" class="form-control character-count-field"
                                    ...
                                    <div class="d-flex justify-content-end gap-3 mt-3">
                                        <button class="btn btn-primary" id="addWallet"
            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <form method="GET" action="{{ url()->full() }}" >
                        ...
                        <div class="d-flex justify-content-end gap-3 mt-3">
                            <button class="btn btn-primary date-range-submit"
