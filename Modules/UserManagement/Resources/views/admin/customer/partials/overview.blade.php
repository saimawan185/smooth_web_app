                            ...
                            <ul class="list-unstyled d-flex flex-column gap-3 text-dark mb-0">
                                ...
                                <li>
                                    <div class="d-flex gap-3 justify-content-between">
                                        ...
                                        <span
                                            class="badge badge-primary fs-14">{{getCurrencyFormat($commonData['customer_lowest_fare']??0)}}</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="d-flex gap-3 justify-content-between">
                                        ...
                                        <span
                                            class="badge badge-primary fs-14">{{getCurrencyFormat($commonData['customer_highest_fare'] ?? 0)}}</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="list-unstyled d-flex flex-column gap-3 text-dark mb-0">
                                ...
                                <li>
                                    <div class="d-flex gap-3 justify-content-between">
                                        ...
                                        <span
                                            class="badge badge-primary fs-14">{{getCurrencyFormat($commonData['customer']->userAccount()->value('wallet_balance') ?? 0)}}</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
