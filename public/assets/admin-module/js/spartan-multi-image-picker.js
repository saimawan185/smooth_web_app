    ...
    $.fn.spartanMultiImagePicker = function (options) {
        ...
        function addRow(settings, el) {
            ...
            var template =
                ...
                `${uploadLoaderIcon}` +
                `</div>` +
                `<label class="file_upload" style="width: 100%; height: ${rowHeight}; border: 2px dashed #ddd; border-radius: 0.625rem; cursor: pointer; text-align: center; position : relative; display: flex; align-items: center; margin: auto; justify-content: center; flex-direction: column;">` +
                `<a href="javascript:void(0)" data-spartanindexremove="${count}" style="display: none;"  class="spartan_remove_row"><i class="tio-clear"></i></a>` +
                `<img style="margin: 0 auto; vertical-align: middle;" data-spartanindexi="${count}" src="${placeholderImageTarget}" class="spartan_image_placeholder" /> ` +
                ...
                `</label> ` +
                `<div id="overlay" class="image-loadng-overlay hidden">
                                        <div class="progress-bar">
                                            <P class="fs-13 fw-medium">Uploading</P>
